...
8. **Create EB Environment** *(optional)* - Create new environment if needed
...
eb create zeerostock-prod --instance-type t3.medium --scale 2
```
...
- `zeerostock-production-env` - Production `.env` file
